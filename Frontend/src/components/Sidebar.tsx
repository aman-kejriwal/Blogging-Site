        ...
        <>
            ...
            <aside style={panelStyle}>
                ...
                <nav style={navStyle}>
                    ...
                    <button
                        style={isActive("/library") ? navItemActive : navItemBase}
                        onClick={() => handleNav("/library")}
                        onMouseEnter={e => { if (!isActive("/library")) { e.currentTarget.style.background = '#f5f5f4'; e.currentTarget.style.color = '#1c1917'; } }}
                        onMouseLeave={e => { if (!isActive("/library")) { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = '#57534e'; } }}
                    >
                        <svg style={{ ...iconStyle, color: isActive("/library") ? '#1a8917' : undefined }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
